...
import {
    MenuFoldOutlined, MenuUnfoldOutlined, DoubleRightOutlined, LogoutOutlined, CheckSquareFilled, CalendarOutlined, UnorderedListOutlined, DeleteOutlined, MoreOutlined, EditOutlined, WalletOutlined, PlusOutlined
                        ...
                        <Layout style={{
                            ...
                            <Sider trigger={null} collapsible collapsed={collapsed}
                                ...
                                <Menu
                                    ...
                                    style={{ background: "transparent" }}
                                    items={[
                                        ...[{ label: "Personal", iconColor: "red" }, { label: "Work", iconColor: "blue" }].map((allLists, i) => {
                                            return (
                                                {
                                                    key: i,
                                                                    ...
                                                                    (todo, i) => {
                                                                        return (
                                                                            <div className="col" key={todo.todoID}>
                                                                                <div className="card  square-card" style={{ width: '100%', height: '100%', backgroundColor: todo.backgroundColor }}>
